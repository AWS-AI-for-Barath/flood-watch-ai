...
NOTE: For hackathon scope, flood simulation is handled by
``flood_propagation.py`` using PostGIS DEM data (no SageMaker needed).
This module remains for future LISFLOOD-FP full-scale simulation
via SageMaker Processing Jobs.

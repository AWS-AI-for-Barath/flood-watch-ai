...
def run_e2e_test():
    ...
    logger.info("  [OK] Phase 3 schema compliance verified")
    ...
    logger.info("  [OK] Predictions retrieved successfully")
    ...
    logger.info("  [OK] Response schema validated")
    ...
    logger.info("")
    logger.info("=" * 60)
    logger.info("[PASSED] END-TO-END TEST PASSED")
    logger.info("=" * 60)
